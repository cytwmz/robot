...
function normalizeSettings(settings = {}) {
  return {
    maxSpeed: clampNumber(settings.maxSpeed, 0.05, 0.15, DEFAULT_BODY_CALIBRATION.maxSpeed),
    gentleSpeed: clampNumber(settings.gentleSpeed, 0.05, 0.15, DEFAULT_BODY_CALIBRATION.gentleSpeed),
    turnSpeed: clampNumber(settings.turnSpeed, 0.05, 0.15, DEFAULT_BODY_CALIBRATION.turnSpeed),
    wiggleSpeed: clampNumber(settings.wiggleSpeed, 0.05, 0.15, DEFAULT_BODY_CALIBRATION.wiggleSpeed),
    ...
    minPwm: clampRound(settings.minPwm, 0, 70, DEFAULT_BODY_CALIBRATION.minPwm),
